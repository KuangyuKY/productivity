...
merge 1:1 cid year using "E:\HZhang_Xing\data\InvoiceSellData\final_joinby_matched_data_20172018_With_cid_distinctcid.dta"
keep if _merge == 3
drop _merge
...
merge 1:1 eid year using "E:\HZhang_Xing\data\VAT_SellandInput13categories_20172018_IDmatched.dta", force
...
order eid cid year county industry Revenue_Huisuan Profit_Huisuan Labor Expend_Capital VAT_Revenue VAT_Pindex_output VAT_Qindex_output VAT_Exp_M VAT_Pindex_INP_m VAT_Qindex_INP_m
