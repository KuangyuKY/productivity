...
use "E:\HZhang_Xing\data\VAT_SellandInput13categories_2017_yearmonth_weightprice.dta", clear
merge m:1 cid year using "E:\HZhang_Xing\data\InvoiceSellData\final_joinby_matched_data_20172018_With_cid_distinctcid.dta"
keep if _merge == 3
drop _merge

bysort eid yearmonth: gen rep_no = _n
drop if rep_no >1
tab year
drop rep_no
distinct cid

save "E:\HZhang_Xing\data\VAT_SellandInput13categories_2017_IDmatched_yearmonth_weightprice.dta",replace
...
merge 1:m eid year using "E:\HZhang_Xing\data\VAT_SellandInput13categories_2017_IDmatched_yearmonth_weightprice.dta", force
...
order eid cid yearmonth year county industry Revenue_Huisuan Profit_Huisuan Labor Expend_Capital VAT_Revenue VAT_Pindex_output VAT_Qindex_output VAT_Exp_M VAT_Pindex_INP_m VAT_Qindex_INP_m
...
save "E:\HZhang_Xing\data\sample\VAT_Huisuan_matched_2017_yearmonth_weightprice.dta", replace
